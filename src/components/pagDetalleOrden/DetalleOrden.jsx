...
const DetalleOrden = () => {
    const productos = [
        { id: 2223, nombre: "Mario Kart", categoria: "Videojuegos", cantidad: 10, total: 19.00, img: img1 },
        { id: 6425, nombre: "2K26", categoria: "Videojuegos", cantidad: 4, total: 19.00, img: img2 },
        { id: 2344, nombre: "Nintendo Switch with Joy", categoria: "Consola", cantidad: 4, total: 19.00, img: img3 },
        { id: 4344, nombre: "Jazwares Pokemon Gengar 24", categoria: "Coleccionable", cantidad: 12, total: 19.00, img: img4 },
        { id: 5454, nombre: "METAL GEAR SOLID DELT", categoria: "Videojuegos", cantidad: 1, total: 19.00, img: img5 },
        { id: 8123, nombre: "Auriculares PC", categoria: "Periferico", cantidad: 1, total: 19.00, img: img6 },
    ];
